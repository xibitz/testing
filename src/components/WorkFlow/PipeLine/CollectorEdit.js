...
class CollectorEdit extends Component {
  ...
  render() {
    if (this.state.serviceData) {
      ...
      let output = JSON.stringify(order, undefined, 3);
          ...
          <FormGroup>
            ...
            <FormControl>
              ...
              <Input
                ...
                id="my-input"
                value="Syncron123"
                aria-describedby="your field name here"
                onChange={this.handleChange}
              />
            </FormControl>
            <FormControl>
            ...
            <FormControl>
              ...
              <Input
                name="name"
                id="my-input"
                value="http://oracle.com/rest/api"
                aria-describedby="your field name here"
                onChange={this.handleChange}
              />
            </FormControl>
